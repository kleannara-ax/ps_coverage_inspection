...
> **참고**: `module-jri/src/main/resources/db/migration/`에는 SQL을 두지 않습니다.
> `ddl-auto=none` 환경에서 DBA가 직접 실행하는 방식으로 모듈 내부 `sql/module-{모듈명}/`에 배치합니다.
...
3. SQL 스크립트 실행: `module-jri/sql/module-jri/01_schema.sql`
